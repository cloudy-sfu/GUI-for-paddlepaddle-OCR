...
def recognize_text(images=None, text_thresh=0.5, angle_classification_thresh=0.9, batch_num=30):
    if not images:
        raise Exception("There is not any image to be predicted. Please check the input data.")
